...
function main() {
    ...
    setFactionDOM(freePeoples, shadow);
    setFactionEvents(freePeoples, shadow);
...
function setFactionDOM(freePeoples, shadow) {
...
function setFactionEvents(freePeoples, shadow) {
